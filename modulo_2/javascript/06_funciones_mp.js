console.log("BUCLES — GESTIÓN DE EVENTOS Y CONFERENCIAS");

for (let i=1; i <=10;i++){
    console.log("numero", i);
}
console.log("sumatoria indices — GESTIÓN DE EVENTOS Y CONFERENCIAS");
...
console.log("Bucle While — GESTIÓN DE EVENTOS Y CONFERENCIAS");
let i=1
while(i<=6){
